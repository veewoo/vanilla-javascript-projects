...
console.log(numUniqueEmails(["alice.z@leetcode.com", "alicez@leetcode.com"]));
...
function numUniqueEmails(emails) {
  ...
  for (let i = 0; i < emails.length; i++) {
    ...
    const separationSignIndex = email.indexOf("@");

    while (index < separationSignIndex) {
      char = email[index];
      index++;
    ...
    map.set(value + email.substring(separationSignIndex, email.length));
  }
